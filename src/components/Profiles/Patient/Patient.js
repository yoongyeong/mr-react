	...
	return (
		<div className="patient sh-sf rad-5">
			<div className="patient__top">
				<img src={currentPatient.image.inUse} alt={currentPatient.fullName} className="patient-img rad-5 sh-sf" />
			...
			<div className="patient__bot">
				<div className="btn">
					<ButtonCustom variant="contained" text="Patient Folder" startIcon={<Folder />} color="primary" />
				</div>
			</div>
		</div>
	);
